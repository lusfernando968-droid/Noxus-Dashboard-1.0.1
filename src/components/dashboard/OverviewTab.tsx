...
import { TrendingUp, Users, Briefcase, DollarSign, Calendar, ArrowUpRight, ArrowDownRight, BarChart3, Brain, Bell } from "lucide-react";
import { AdvancedCharts } from "./AdvancedCharts";
import { SmartInsights } from "./SmartInsights";
import { DraggableWidgets } from "./DraggableWidgets";
import { MetasOverviewCard } from "./MetasOverviewCard";
...
export function OverviewTab({ projetos, clientes, transacoes, agendamentos, onOpenMetasTab, onCreateMeta }: OverviewTabProps) {
  ...
  return (
    <div className="space-y-8">
            ...
            >
              ...
              <div className="mt-4 space-y-2">
                ...
                <div className="w-full bg-muted rounded-full h-1.5">
                  <div 
                    className={`h-1.5 rounded-full transition-all duration-1000 ease-out ${stat.color.replace('text-', 'bg-')}`}
                    style={{ 
      ...
      {/* Card de Metas - Largura Total */}
      <div className="w-full">
        <MetasOverviewCard 
          onOpenMetasTab={onOpenMetasTab}
